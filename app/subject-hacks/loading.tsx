  ...
  return (
    <main className="flex-1 p-3.5 sm:p-5 md:py-6 md:px-6 lg:px-8 max-w-[1680px] mx-auto w-full space-y-8 min-h-[calc(100dvh-4rem)] animate-page-enter">
      ...
      <div className="flex items-center gap-3.5">
        <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-fuchsia-500/15 ring-1 ring-fuchsia-500/30 animate-pulse" />
      ...
      <div className="overflow-hidden rounded-2xl border border-fuchsia-500/20 bg-card/90 shadow-sm dark:border-fuchsia-500/15 dark:bg-[#111820]">
        ...
        <div className="p-6 pb-3">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 shrink-0 rounded-xl bg-fuchsia-500/20 animate-pulse" />
            <div className="space-y-1.5">
        ...
        <div className="px-6 pb-6 pt-0">
          <div className="h-10 w-28 rounded-xl bg-fuchsia-500/20 dark:bg-fuchsia-500/15 animate-pulse" />
        </div>
      </div>
